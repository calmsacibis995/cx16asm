...
OUT15
	PHA                 ;SAVE A REGISTER
	LDA $0001           ;IS THE CURRENT ROM BANK #0?
	PHA                 ;SAVE ORIGINAL BANK NUMBER
	CMP #$00
	BNE OUT16           ;IT ISN'T, SWITCH IT
	PLA                 ;RESTORE SAVED BANK NUMBER
	PLA                 ;RESTORE SAVED A REGISTER
	JMP OUT17           ;IT IS, PROCEED
OUT16
	LDA #0              ;SWITCH ROM BANK TO #0
	STA $0001
	JSR PRT
	PLA                 ;RESTORE ORIGINAL BANK NUMBER
	STA $0001
	PLA                 ;RESTORE SAVED A REGISTER
	JMP OUT20
OUT17
